 ...
 *
 * NOTA:
 * Se il sito NON prevede l'addon dei Ticket NON usare questo componente e
 * sostituirlo con il componente login-form
 *
 *
 * Gestisce:
 * - procedura di login;
...
export default class StandardCoreLoginFormTicketComponent extends Component {
  ...
  async start() {
    ...
    if (
      ticketInfo.ticketActive &&
      ticketInfo.ticketTenantEnabled &&
      ticketInfo.canChoiseUnlogged > 0
    ) {
