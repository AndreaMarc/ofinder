...
module(
  'Integration | Component | standard/core/setup-profile',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`<Standard::Core::SetupProfile @recordWeb={{this.recordWeb}} @serviceAvailable={{this.serviceAvailable}}/>`
      );

      //conto il numero di input
      //cambiare il numero se si aggiungono o rimuovono Input
      let InputExpected = 65;
