...
{
    public class ErpRoleController : JsonApiController<ErpRole, string>
    {
        private readonly IResourceService<ErpRole, string> _resourceService;
        ...
        public ErpRoleController(
            IJsonApiManualService jsonManualService,
            IDocumentService docService,
            IJsonApiOptions options,
            IResourceGraph resourceGraph,
            ILoggerFactory loggerFactory,
            IResourceService<ErpRole, string> resourceService,
            IResourceService<Role, string> roleService,
