...
{
    public class ErpEmployeeController : JsonApiController<ErpEmployee, string>
    {
        private readonly IResourceService<ErpEmployee, string> _resourceService;
        ...
        public ErpEmployeeController(
            IJsonApiManualService jsonManualService,
            IDocumentService docService,
            IJsonApiOptions options,
            IResourceGraph resourceGraph,
            ILoggerFactory loggerFactory,
            IResourceService<ErpEmployee, string> resourceService,
