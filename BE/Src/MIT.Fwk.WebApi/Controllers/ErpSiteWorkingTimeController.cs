...
{
    public class ErpSiteWorkingTimeController : JsonApiController<ErpSiteWorkingTime, string>
    {
        private readonly IResourceService<ErpSiteWorkingTime, string> _resourceService;
        private readonly IResourceService<ErpSite, string> _siteService;
        private readonly IResourceService<ErpShift, string> _shiftService;
        ...
        public ErpSiteWorkingTimeController(
            IJsonApiManualService jsonManualService,
            IDocumentService docService,
            IJsonApiOptions options,
            IResourceGraph resourceGraph,
            ILoggerFactory loggerFactory,
            IResourceService<ErpSiteWorkingTime, string> resourceService,
            IResourceService<ErpSite, string> siteService,
            IResourceService<ErpShift, string> shiftService,
