...
{
    public class ErpShiftController : JsonApiController<ErpShift, string>
    {
        private readonly IResourceService<ErpShift, string> _resourceService;
        ...
        public ErpShiftController(
            IJsonApiManualService jsonManualService,
            IDocumentService docService,
            IJsonApiOptions options,
            IResourceGraph resourceGraph,
            ILoggerFactory loggerFactory,
            IResourceService<ErpShift, string> resourceService,
